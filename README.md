Inputs a sentence or multiple sentences from the user, tokenizes the input, and then provides individual sentiment (mostly positive, mostly negative, mostly neutral) as the result.
